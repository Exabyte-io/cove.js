...
const iconComponentMap: Record<string, typeof SvgIcon | ReturnType<typeof rotateIcon>> = {
    ...
    "unitType.convergence": RadioButtonUnchecked,
    "unitType.execution": Circle,
    "unitType.exit": Close,
    "unitType.io": Storage,
    "unitType.map": rotateIcon(CallSplit, 180),
    "unitType.processing": RadioButtonChecked,
    "unitType.reduce": rotateIcon(CallMerge, 180),
    "unitType.subworkflow": Adjust,

    "privacy.public": Public,
    "privacy.withMe": Share,

    "accounts.bank": AccountBalance,
    "accounts.curators": LibraryBooks,
    "accounts.enterprise": Language,
    "accounts.externalPublic": Public,
    "accounts.externalWithLink": Link,
    "accounts.individual": AccountCircle,
    "accounts.organization": GroupsRounded,
    "accounts.personal": Face,
    "accounts.public": People,

    "billing.addBalance": CalculateOutlined,
    "billing.card": CreditCard,
    "billing.charge": Receipt,
    "billing.credit": AttachMoney,
    "billing.overview": AutoGraph,
    "billing.payment": AttachMoney,
    "billing.paymentFilled": Paid,
    "billing.storageQuota": Memory,
    "billing.totalBalance": AccountBalanceWalletOutlined,

    "properties.bandGap": UnfoldLess,
    "properties.energy": BatteryChargingFullOutlined,
    "properties.energyProfile": SwapCalls,
    "properties.fermiEnergy": FlashOn,
    "properties.force": OpenWith,
    "properties.pressure": SystemUpdateAlt,

    "files.dropbox": SettingsSystemDaydream,
    "files.externalUpload": CloudUploadOutlined,
    "files.file": InsertDriveFile,
